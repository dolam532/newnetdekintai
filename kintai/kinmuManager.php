        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="workstrTime--cmodal" placeholder="09:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-6">
                            <label for="workendTime--cmodal">業務終了時間</label>
                            <input type="text" class="form-control" id="workendTime--cmodal" placeholder="18:00" required="required" style="text-align: center">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="offtime1--cmodal" placeholder="01:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-3">
                            <label for="offtime2--cmodal">夜休(時:分)</label>
                            <input type="text" class="form-control" id="offtime2--cmodal" placeholder="00:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-6">
                            <label for="bigo--cmodal">備考</label>
                            <input type="text" class="form-control" id="bigo--cmodal" placeholder="備考" required="required" style="text-align: left">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer" style="text-align: center">
                    ...
                    <div class="col-md-2">
                        <p class="text-center"><a class="btn btn-primary btn-md" id="btnUpd--cmodal" onclick="handleupdateModal()" role="button">編集 </a></p>
                    </div>
                    <div class="col-md-2">
                        <p class="text-center"><a class="btn btn-primary btn-md" id="btnDel--cmodal" href="#" onclick="handledeleteModal()" role="button">削除 </a></p>
                    </div>
                    <div class="col-md-2">
                        <p class="text-center"><a class="btn btn-warning btn-md" id="btnRet--cmodal" href="#" onclick="handlerCloseModal(2)" role="button" data-dismiss="modal">閉じる </a></p>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="workstrTime--rmodal" placeholder="09:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-6">
                            <label for="workendTime--rmodal">業務終了時間</label>
                            <input type="text" class="form-control" id="workendTime--rmodal" placeholder="18:00" required="required" style="text-align: center">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="offtime1--rmodal" placeholder="01:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-3">
                            <label for="offtime2--rmodal">夜休(時:分)</label>
                            <input type="text" class="form-control" id="offtime2--rmodal" placeholder="00:00" required="required" style="text-align: center">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="modal-footer" style="text-align: center">
                    <div class="col-md-3"></div>
                    <div class="col-md-3">
                        <p class="text-center"><a class="btn btn-primary btn-md" id="btnDel--rmodal" href="#" onclick="handlerRegisterModal()" role="button">登録 </a></p>
                    </div>
                    <div class="col-md-3">
...
<script>
    ...
    function changeShowStatus(status) {
        // if true => show data, if false => show データが存在しません
