...
<div class="container" style="margin-top:-20px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span>
                            <a href="#">
                                <span class="showModal"><?= $key['companyname'] ?><span
                                        class="manageinfo_class"><?= ',' . $key['companyid'] ?></span></span>
                            </a>
                        </span>
                    </td>
                ...
                <form method="post">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    ...
                                    <input type="text" class="form-control" name="companyid" id="companyid"
                                        value="<?= $new_companyID_mi ?>" maxlength="10" style="text-align: left"
                                        readonly>
                                </div>
                                <div class="col-xs-9">
                                    <label for="companyname">Company Name</label>
                                    <input type="text" class="form-control" name="companyname" id="companyname"
                                        placeholder="xxx株式会社" maxlength="20" style="text-align: left">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="magamym" id="magamYm"
                                        placeholder="2019/01" maxlength="100" style="text-align: left">
                                </div>
                                <div class="col-xs-6">
                                    <label for="telno">締切（日）</label>
                                    <input type="text" class="form-control" name="magamymd" id="magamYmd"
                                        placeholder="2019/01/01" maxlength="100" style="text-align: left">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer" style="text-align: center">
                            ...
                            <div class="col-xs-2">
                                <p class="text-center">
                                    <input type="submit" name="btnRegMMI" class="btn btn-primary" id="btnRegMMI"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-xs-3">
                                    <label for="companycode">Company ID</label>
                                    <input type="text" class="form-control" name="udcompanyid" id="udcompanyid"
                                        value="<?= $new_companyID_mi ?>" maxlength="10" style="text-align: left"
                                        readonly>
                                </div>
                                <div class="col-xs-9">
                                    <label for="companyname">Company Name</label>
                                    <input type="text" class="form-control" name="udcompanyname" id="udcompanyname"
                                        placeholder="xxx株式会社" maxlength="20" style="text-align: left">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-xs-6">
                                    <label for="staff">締切（月）</label>
                                    <input type="text" class="form-control" name="udmagamym" id="udmagamYm"
                                        placeholder="2019/01" maxlength="100" style="text-align: left">
                                </div>
                                <div class="col-xs-6">
                                    <label for="telno">締切（日）</label>
                                    <input type="text" class="form-control" name="udmagamymd" id="udmagamYmd"
                                        placeholder="2019/01/01" maxlength="100" style="text-align: left">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer" style="text-align: center">
                            ...
                            <div class="col-xs-2">
                                <p class="text-center">
                                    <input type="submit" name="btnUpdateMMI" class="btn btn-primary" id="btnUpdateMMI"
    ...
    <form method="post">
        <div class="row">
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    ...
                    <input id="companyid" name="companyid" placeholder="Company ID" class="form-control" type="text"
                        value="<?= $key['companyid'] ?>" readonly>
                </div>
                <div class="col-md-10">
                    <label for="companyname">Company Name</label>
                    <input id="companyname" name="companyname" placeholder="Company Name" class="form-control"
                        type="text" value="<?= $key['companyname'] ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="magamYm">締切（月）</label>
                    <input id="magamYm" name="magamYm" placeholder="yyyy/mm" class="form-control" type="text"
                        value="<?= $key['magamym'] ?>">
                </div>
                <div class="col-md-2">
                    <label for="magamYmd">締切（日）</label>
                    <input id="magamYmd" name="magamYmd" placeholder="yyyy/mm/dd" class="form-control" type="text"
                        value="<?= $key['magamymd'] ?>">
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                <p class="text-center"><a class="btn btn-default btn-md" id="btnClose" href="../contact/noticeList.php"
                        role="button">閉じる </a></p>
            </div>
            <div class="col-xs-4"></div>
        </div>
...
$(document).on('click', '.showModal', function() {
    ...
    <?php
        foreach ($manageinfo_list as $key) {
        ?>
    if ('<?php echo $key['companyid'] ?>' === CompanyId && '<?php echo $key['companyname'] ?>' ===
        CompanyName) {
