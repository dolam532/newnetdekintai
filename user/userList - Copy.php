					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-3">
								...
								<input type="text" class="form-control" id="uid" name="uid" placeholder="ID"
									required="required" maxlength="10" style="text-align: left">
							...
							<div class="col-xs-3">
								...
								<input type="text" class="form-control" id="grade" name="grade" placeholder="役員/管理/社員"
						...
						<div class="row">
							...
							<div class="col-xs-6">
								...
								<input type="text" class="form-control" id="dept" name="dept" placeholder="開発部"
									maxlength="50" style="text-align: left">
							</div>
						</div>
						<br>
						<div class="row">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-3">
								<label for="uid">ID</label>
								<input type="text" class="form-control" id="uluid" name="uluid" style="text-align: left"
									readonly>
							...
							<div class="col-xs-3">
								...
								<input type="text" class="form-control" id="ulgrade" name="ulgrade"
									placeholder="役員/管理/社員" required="required" maxlength="30" style="text-align: left">
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col-xs-6">
								<label for="dept">部署</label>
								<input type="text" class="form-control" id="uldept" name="uldept" placeholder="開発部"
									maxlength="50" style="text-align: left">
							</div>
						</div>
						<br>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<span id="udsignstamp_name" hidden></span>
		...
		if (!empty($userlist_list)) {
			foreach ($userlist_list as $key) {
				...
				if ('<?php echo $key['uid'] ?>' == Uid) {
                    ...
                    // var udsignstamp_name = $("input[name=udsignstamp_name]:hidden");
                    // udsignstamp_name.val("<?php echo $user['signstamp'] ?>");
                    // var udsignstamp_name = udsignstamp_name.val();
				}
				<?php
			}
		}
