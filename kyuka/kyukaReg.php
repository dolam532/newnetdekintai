                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                ...
                                <?php if ($_SESSION['auth_type'] == constant('ADMIN') || $_SESSION['auth_type'] == constant('ADMINISTRATOR') || $_SESSION['auth_type'] == constant('MAIN_ADMIN')) : ?>
                                <a href="#"><span style="color:red;text-decoration-line: underline;"
                                        class="showModal2">未決裁<span
                                            class="vacationid_class"><?= ',' . $userkyuka['uid'] . ',' . $userkyuka['ymdcnt']  . ',' . $userkyuka['timecnt'] ?></span></span>
                                    <?php else : ?>
                        ...
                        <div class="modal-body" style="text-align: left; height: 600px; overflow-y: auto;">
                            ...
                            <div class="row six">
                                ...
                                <div class="col-md-3 col-sm-3 col-sx-3">
                                    ...
                                    <input type="text" class="form-control" id="usenowcnt" name="usenowcnt"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class="col-md-3 col-sm-3 col-sx-3">
                                    <label for="usefinishaftercnt">使用後済</label>
                                    <input type="text" class="form-control" id="usefinishaftercnt"
                                        name="usefinishaftercnt" placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class="col-md-3 col-sm-3 col-sx-3">
                                    <label for="useafterremaincnt">使用後残</label>
                                    <input type="text" class="form-control" id="useafterremaincnt"
                                        name="useafterremaincnt" placeholder="番号" style="text-align: center" value="">
                                </div>
                            </div>
                            <br>
                            <div class="row seven">
                            ...
                            <div class="row eight">
                                ...
                                <div class="col-md-4 col-sm-4 col-sx-4 address">
                                    ...
                                    <input type="text" class="form-control" name="destplace" id="destplace"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: left; height: 600px; overflow-y: auto;">
                            ...
                            <div class="row four">
                                <div class="col-md-3 col-sm-3 col-sx-3 day">
                                    ...
                                    <input type="text" class="form-control" id="udstrymd" name="udstrymd"
                                        placeholder="日付" required="required" maxlength="10" style="text-align: center">
                                </div>
                                <div class="col-md-3 col-sm-3 col-sx-3 day">
                                    <label for="endymd">期間(T)</label>
                            ...
                            <div class="row five">
                                <div class="col-md-3 col-sm-3 col-sx-3">
                                    <label for="tothday">総有給休暇</label>
                                    <input type="text" class="form-control" id="udtothday" name="udtothday"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class="col-md-3 col-sm-3 col-sx-3">
                                    <label for="oldcnt">前年度の繰越残</label>
                                    <input type="text" class="form-control" id="udoldcnt" name="udoldcnt"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class=" col-md-3 col-sm-3 col-sx-3">
                                    <label for="newcnt">当該年度付与</label>
                                    <input type="text" class="form-control" id="udnewcnt" name="udnewcnt"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class="col-md-3 col-sm-3 col-sx-3 no">
                                    <label for="usefinishcnt">使用済数</label>
                            ...
                            <div class="row seven">
                                ...
                                <div class="col-md-2 col-sm-2 col-sx-2">
                                    <label for="ymdcnt">申請日数</label>
                                    <input type="text" class="form-control" id="udymdcnt" name="udymdcnt"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                                <div class="col-md-2 col-sm-2 col-sx-2">
                                    <label for="timecnt">
                                    ...
                                    <input type="text" class="form-control" id="udtimecnt" name="udtimecnt"
                                        placeholder="番号" style="text-align: center" value="">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="modal-footer" style="text-align: center">
                                ...
                                <div class="col-xs-2">
                                    <p class="text-center">
                                        <input type="submit" name="UpdateKyuka" class="btn btn-primary"
                                            id="btnUpdateKyuka" role="button" value="編集">
                                    </p>
                                </div>
                                <div class="col-xs-2">
                                    <p class="text-center">
                        ...
                        <div class="modal-body" style="text-align: left">
                            <div class="row one">
                                ...
                                <div class="col-md-4 col-sm-4 col-sx-4 uid">
                                    ...
                                    <input type="text" class="form-control" id="duid" name="duid"
